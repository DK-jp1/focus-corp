...
export default function ValueSection() {
  return (
    <section id="value" className="section-white section-glow-border corner-glow-tr py-16 md:py-24 px-6">
      <div className="relative z-10 max-w-3xl mx-auto text-navy">
        ...
        <div className="fade-in-up text-center mb-12">
          ...
          <h2 className="text-2xl md:text-3xl font-bold tracking-wide mb-5">行動指針</h2>
