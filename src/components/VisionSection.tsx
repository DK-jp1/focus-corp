...
export default function VisionSection() {
  return (
    <section id="vision" className="section-light section-glow-border corner-glow-bl py-32 md:py-44 px-6">
      <div className="relative z-10 max-w-5xl mx-auto">
        {/* 見出し */}
        <div className="fade-in-up text-center mb-20">
          <p className="label-en text-accent text-xs tracking-[0.3em] uppercase mb-4 font-medium">Vision</p>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-navy mb-5">
            可能性が、無限に広がる街へ
          </h2>
