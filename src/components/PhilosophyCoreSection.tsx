...
export default function PhilosophyCoreSection() {
  return (
    <section id="philosophy-core" className="section-light section-glow-border corner-glow-tr py-32 md:py-44 px-6">
      <div className="relative z-10 max-w-3xl mx-auto">
        {/* 見出し */}
        <div className="fade-in-up text-center mb-20">
          <p className="label-en text-accent text-xs tracking-[0.3em] uppercase mb-4 font-medium">Philosophy</p>
          <h2 className="text-3xl md:text-5xl font-black text-navy mb-5">focus哲学の核心概念</h2>
